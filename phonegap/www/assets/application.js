...
(function() {
  var clean_text, disable_links, make_data;

  $(document).on("ready", function() {
    $('.showbill').on("keyup", function() {
      return $.ajax({
        method: "PATCH",
        url: "showbill/" + $(this).attr("id"),
        data: make_data($(this)),
        dataType: "script"
      });
    });
    $('.showbill-div').on("click", function() {
      var text;
      if ($('textarea').is('.showbill')) {
        ...
        $('.showbill').show().focus();
        return $('.showbill-div').hide();
      }
    });
    return $('.showbill').on("blur", function() {
      $('.showbill').hide();
      return $('.showbill-div').show();
    });
  });

  make_data = function(item) {
    return {
      showbill: {
